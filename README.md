...
# Tools & Library Used
<img src="MAVEN/mysql_img.png" width="400"/> &nbsp;
# Project Result

[Click here to get full code](https://github.com/SarthakUdavant/MAVEN-MOVIES/blob/main/maven_renatl_movies.sql)

# Query Task

1. "How can we extract the first name, last name, and email address of all customers to prepare a comprehensive contact list for the marketing team?"

<img src="https://github.com/SarthakUdavant/MAVEN-MOVIES/blob/main/MAVEN/email.png" alt="email.png" width="400"/> &nbsp;


2. "What is the total number of movies in the inventory that are available for rent at the lowest rental rate of $0.99?"

<img src="MAVEN/CHEAPEST_RENTAL.png" alt="CHEAPEST_RENTAL.png" width="200"/> &nbsp;


3. "How can we categorize all movies based on their rental rates and determine the count of movies in each category?"

<img src="MAVEN/TOTAL_NO_OF_MOVIES.png" alt="TOTAL_NO_OF_MOVIES.png" width="400"/> &nbsp;
...
<img src="MAVEN/rating_wise_count.png" alt="rating_wise_count.png" width="400"/> &nbsp;
...
<img src="MAVEN/REWARD_VIA_PHONE.png" alt="REWARD_VIA_PHONE.png" width="400"/> &nbsp;

12. "Could you pull all payments from our first 100 customers (Based on customers id)"

<img src="MAVEN/FIRST_100_CUSTOMER_PAYMENTS.png" alt="FIRST_100_CUSTOMER_PAYMENTS.png" width="400"/> &nbsp;

13. "Now I’d love to see just payments over $5 for those same customers, since January 1, 2006"

<img src="MAVEN/JAN_06_2006.png" alt="JAN_06_2006.png" width="400"/> &nbsp;
...
<img src="MAVEN/PAYMENTS_OVER_$5.png" alt="PAYMENTS_OVER_$5.png" width="400"/> &nbsp;
...
<img src="MAVEN/BTS.png" alt="BTS.png" width="400"/> &nbsp;

16. "Which customer qualifies as the top spender, and what rewards or points should we offer them?"

<img src="MAVEN/MOST_SPENDING_CUSTOMER.png" alt="MOST_SPENDING_CUSTOMER.png" width="400"/> &nbsp;

17. "Could you please pull a count of titles sliced by rental duration?"

<img src="MAVEN/SLICED_BY_RENTAL_RATE.png" alt="SLICED_BY_RENTAL_RATE.png" width="400"/> &nbsp;

18. "How do movie ratings and lengths correlate with rental demand (number of movies rented) across various rental periods?"

<img src="MAVEN/COMPARE_WITH_RENTAL_DURATION.png" alt="COMPARE_WITH_RENTAL_DURATION.png" width="400"/> &nbsp;
...
<img src="MAVEN/MIN_MAX_AVG.png" alt="MIN_MAX_AVG.png" width="400"/> &nbsp;
...
<img src="MAVEN/FIT_FOR_RECOMMENDATION.png" alt="FIT_FOR_RECOMMENDATION.png" width="400"/> &nbsp;
...
<img src="MAVEN/ACTIVE_STORE.png" alt="ACTIVE_STORE.png" width="400"/> &nbsp;
...
<img src="MAVEN/FILMS_IN_INVENTORY.png" alt="FILMS_IN_INVENTORY.png" width="400"/> &nbsp;

23. "Can you list the movies that [FIRST_NAME] [LAST_NAME] has been part of, and how many are there in total?"

<img src="MAVEN/NO_OF_FILMS_BY_ACTOR.png" alt="NO_OF_FILMS_BY_ACTOR.png" width="400"/> &nbsp;
...
<img src="MAVEN/ACTOR_ASSOCIATED_WITH_TITLE.png" alt="ACTOR_ASSOCIATED_WITH_TITLE.png" width="400"/> &nbsp;
...
<img src="MAVEN/FAV_ACTOR_APPEAR.png" alt="FAV_ACTOR_APPEAR.png" width="400"/> &nbsp;
...
<img src="MAVEN/COLLECTION_OF_STORE_2.png" alt="COLLECTION_OF_STORE_2.png" width="400"/> &nbsp;
...
<img src="MAVEN/UNION.png" alt="UNION.png" width="400"/> &nbsp;
